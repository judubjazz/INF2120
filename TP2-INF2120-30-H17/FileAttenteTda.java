 ...
 * @version 8 mars 2017
 */
public interface FileAttenteTda<T extends OrdonnableParPrioriteEtDateHeure> extends Iterable<T> {
	 ...
	 *   - L'élément est null.
	 *   - L'élément existe déjà dans la file (2 éléments identiques s'ils ont
	 *     le même identifiant).
    ...
    */
	 ...
	 */
      ...
      * 
      * Étant donné que l'interface FileAttenteTda<T> hérite de l’interface Iterable<T>, 
      * vous devez redéfinir la méthode iterator() dans votre classe FileAttenteChaineeImpl. 
      * Cette méthode retourne un objet Iterator<T> qui permettra de parcourir notre file d'attente.
      *
      */
}
